...
- **CLAUDE.md v2.12.1** — corrected the repo URL to `github.com/Vybecode-LTD/Ide_AI` (was the stale `PromptMonster-Media-Ltd` org). `AGENTS.md` still carries the old URL but is stale overall and slated for separate reconciliation/removal.
